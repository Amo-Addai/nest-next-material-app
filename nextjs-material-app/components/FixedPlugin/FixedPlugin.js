        ...
        <ul className="dropdown-menu">
          ...
          <li className="button-container">
            <div className="button-container">
              <Button
                color="success"
                href="https://www.AUTO.com/product/nextjs-material-dashboard?ref=njsmd-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Download free!
          ...
          <li className="button-container">
            <div className="button-container">
              <Button
                color="warning"
                href="https://www.AUTO.com/product/nextjs-material-dashboard-pro?ref=njsmd-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Get PRO version
          ...
          <li className="button-container">
            <Button
              color="info"
              fullWidth
              href="https://www.AUTO.com/learning-lab/nextjs/overview/material-dashboard?ref=njsmd-fixed-plugin"
              target="_blank"
            >
              Documentation
            </Button>
